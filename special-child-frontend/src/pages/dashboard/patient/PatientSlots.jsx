...
export default function PatientSlots() {
  ...
  return (
    <div>
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(150px, 1fr))', gap: '14px', marginBottom: '24px' }}>
        ...
        <StatCard label="Available"   value={available.length}              color="#1D9E75" />
        <StatCard label="Booked"      value={slots.length - available.length} color="#EF9F27" />
      </div>
      <h2 style={{ fontSize: '15px', fontWeight: '500', color: '#111827', marginBottom: '16px' }}>Available Sessions</h2>
