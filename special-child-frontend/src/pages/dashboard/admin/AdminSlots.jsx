  ...
  return (
    <div>
      ...
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '16px' }}>
        <h2 style={{ fontSize: '15px', fontWeight: '500', color: '#111827', margin: 0 }}>All Slots</h2>
        {canWrite && <Button onClick={openCreate}>+ Add Slot</Button>}
      </div>
      ...
      {modal === 'delete' && (
        <Modal title="Delete Slot" onClose={closeModal} width="400px">
          <p style={{ fontSize: '14px', color: '#374151', lineHeight: 1.6, marginBottom: '20px' }}>
            Delete slot <strong>#{selected?.slotId}</strong> for <strong>{selected?.doctorName}</strong>?
          </p>
